...
resource "aws_s3_object" "htme_default_topics_full_csv" {
  bucket     = var.s3_config_bucket_id
...
resource "aws_s3_object" "htme_default_topics_incrementals_csv" {
  bucket     = var.s3_config_bucket_id
...
resource "aws_s3_object" "htme_default_topics_drift_testing_incrementals_csv" {
  bucket     = var.s3_config_bucket_id
